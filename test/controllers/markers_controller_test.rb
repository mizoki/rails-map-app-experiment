...
class MarkersControllerTest < ActionController::TestCase
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post :create, marker: { description: @marker.description, latitude: @marker.latitude, longitude: @marker.longitude, title: @marker.title }
    end
  ...
  test "should update marker" do
    patch :update, id: @marker, marker: { description: @marker.description, latitude: @marker.latitude, longitude: @marker.longitude, title: @marker.title }
    assert_redirected_to marker_path(assigns(:marker))
  end
